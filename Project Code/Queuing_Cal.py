...
canvas = tk.Canvas(root, width=screen_width,
                   height=top_box_height, bg="lightgray")
...
try:
    ...
    # Positioned in the left center
    canvas.create_image(10, 30, image=logo_image_tk, anchor="w")
except Exception as e:
    canvas.create_text(10, top_box_height // 2, text="Logo Not Available",
                       anchor="w", font=("Arial", 12, "bold"))

# Add title text next to the logo (aligned horizontally)
canvas.create_text(630, top_box_height // 2, text="Queuing Calculator",
                   font=("Arial", 22, "bold"), anchor="w", fill='white')
